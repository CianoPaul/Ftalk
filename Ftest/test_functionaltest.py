...
class PageTest(LiveServerTestCase): 
   ...
   def test_enter_and_retrieve(self):
      ...
      inpCust = self.browser.find_element_by_id('custid')
      inpTotal.click()
      inpTotal.send_keys('1236512735')
      ...
      self.assertIn('1: Ciano,JP,Monter,21,Blk 9 Lot 9, Chester Place Mansfield st. Dasmarinas City, Cavite,09473230371,NONE,NONE,3 Months,₱700,1236512735', [row.text for row in rows])
...
#-----2nd
      ...
      rows = table.find_elements_by_tag_name('tr')
      self.assertIn('1: Ciano,JP,Monter,21,Blk 9 Lot 9, Chester Place Mansfield st. Dasmarinas City, Cavite,09473230371,NONE,NONE,3 Months,₱700,1236512735', [row.text for row in rows])
      #self.assertIn('2: Kaedehara,Kazuha,Dimatibag,23,Inazuma,09573430372,NONE,NONE,6 Months,₱1200,1236512735', [row.text for row in rows])
      #self.assertTrue(any(rows.text == '1: JP Pogi'),"No table yet!")

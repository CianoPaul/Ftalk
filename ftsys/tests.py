...
class HomePageTest(TestCase):
	...
	def test_responding_post_request(self):
	   ...
	   self.assertEqual(newItem.customerID, '7623492346')
...
class ORMTest(TestCase):
	def test_saving_retrieving_list(self):
	   ...
	   txtItem1.total = '700'
	   txtItem1.customerID = '7623492346'
	   txtItem1.save()
	   txtItem2 = Item()
	   ...
	   txtItem2.total = '1500'
	   txtItem2.customerID = '1236512735'
	   txtItem2.save()
	   ...
	   self.assertEqual(savedItem1.customerID, '7623492346')
	...
	def test_template_display_list(self):
		...
		Item.objects.create(sname='Kamisato',
	        ...
	        plan='3 Months',
	        total='700',
	        customerID='1236512735')

		response=self.client.get('/')
		self.assertIn('1: Ciano,JP,Monter,21,Chester Place Dasmarinas City,09473230371,None,None,3 Months,700,7623492346', response.content.decode())
		self.assertIn('2: Kamisato,Ayato,De Guzman,25,Inazuma,094564563453,None,None,3 Months,700,1236512735', response.content.decode())